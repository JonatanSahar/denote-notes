...
* DONE A review of contemporary ideomotor theory.
...
- type of paper: study
- why read it?
  it talks about predictive coding in the auditory pathway, and shows a "gradient" of the part of prediction and prediction error along the pathway. talking about the balance or interplay of prediction and low level input, bottom-up vs top-down
- figures:
